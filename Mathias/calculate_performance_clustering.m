            ...
            for cur_nb_intervals_together = 30
                ...
                for cur_background_strength = 1:1
                    for i = 1:nb_iterations
                        [synthetic_data, neurons_in_assembly, activations, synthetic_data_non_zscore] = generate_synthetic_data(stimulus_data_m, sos_results_m, nb_assemblies, nb_neurons, missing_neurons, cur_nb_intervals_together, cur_cur_nb_bins_together, nb_neurons_of_interest, 1, cur_background_strength);
                        ...
                        [pca_nb_assembly_TP, pca_nb_assembly_FP, pca_nb_assembly_FN, pca_nb_neurons_TP, pca_nb_neurons_FP, pca_nb_neurons_FN] = get_performance_clustering({neurons_in_assembly}, pca_assemblies);
                        [cpca_nb_assembly_TP, cpca_nb_assembly_FP, cpca_nb_assembly_FN, cpca_nb_neurons_TP, cpca_nb_neurons_FP, cpca_nb_neurons_FN] = get_performance_clustering({neurons_in_assembly_cpca}, cpca_assemblies);
                        [cica_nb_assembly_TP, cica_nb_assembly_FP, cica_nb_assembly_FN, cica_nb_neurons_TP, cica_nb_neurons_FP, cica_nb_neurons_FN] = get_performance_clustering({neurons_in_assembly_cpca}, cica_assemblies);
...
results_table = table(nb_assembly_array', nb_neurons_array', nb_iterations_array', background_strength', nb_intervals_array', nb_bins_array',...
    ...
    TP_assemblies_cpca', FP_assemblies_cpca', FN_assemblies_cpca', TP_cpca', FP_cpca', FN_cpca', ...
    TP_assemblies_cica', FP_assemblies_cica', FN_assemblies_cica', TP_cica', FP_cica', FN_cica', ...
    'VariableNames',{'NB_Assemblies','NB_Neurons','NB_Iterations', 'Background_Strength', 'NB_Intervals', 'NB_Bins',...
    'TP_assemblies_ICA','FP_assemblies_ICA', 'FN_assemblies_ICA', 'TP_ICA', 'FP_ICA', 'FN_ICA', ...
    'TP_assemblies_CPD','FP_assemblies_CPD', 'FN_assemblies_CPD', 'TP_CPD', 'FP_CPD', 'FN_CPD', ...
    'TP_assemblies_NMF','FP_assemblies_NMF', 'FN_assemblies_NMF', 'TP_NMF', 'FP_NMF', 'FN_NMF', ...
    'TP_assemblies_CPCA', 'TP_assemblies_CPCA', 'TP_assemblies_CPCA', 'TP_CPCA', 'FP_CPCA', 'FN_CPCA', ...
    'TP_assemblies_CICA', 'TP_assemblies_CICA', 'TP_assemblies_CICA', 'TP_CICA', 'FP_CICA', 'FN_CICA'});
    %'TP_assemblies_PCA','FP_assemblies_PCA', 'FN_assemblies_PCA', 'TP_PCA', 'FP_PCA', 'FN_PCA'
