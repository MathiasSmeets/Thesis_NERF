    ...
    for nb_neurons = 2:iterations_nb_neurons
        for missing_neurons = 0:iterations_missing_neurons
            for i = 1:nb_iterations
                [synthetic_data, neurons_in_assembly, activations, synthetic_data_non_zscore] = generate_synthetic_data(stimulus_data_m, sos_results_m, nb_assemblies, nb_neurons, missing_neurons, nb_intervals, bins_together, nb_neurons_of_interest);
