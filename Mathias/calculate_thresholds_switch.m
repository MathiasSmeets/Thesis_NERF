...
for i = setdiff(1:size(stimulus_data_m,1),mouse_to_exclude)
    ...
    save("/scratch/mathiass-takeokalab/01/correlation_distribution_before_m_switchbased8.mat","correlation_distribution_before")
    save("/scratch/mathiass-takeokalab/01/correlation_distribution_after_m_switchbased8.mat","correlation_distribution_after")
    save("/scratch/mathiass-takeokalab/01/correlation_distribution_between_m_switchbased8.mat","correlation_distribution_between")
    save("/scratch/mathiass-takeokalab/01/correlation_distribution_horridge_m_switchbased8.mat","correlation_distribution_horridge")
end
