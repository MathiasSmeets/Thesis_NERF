...
for i = 2:5
    ...
    for cur_nb_intervals_together = 10:10:max_intervals_together
        ...
        for cur_nb_bins_together = 1:5:max_bins_together
            ...
            correct_ica_nb_neurons_2 = sum(results_table.TP_assemblies_ICA(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));

            correct_cpd_nb_neurons_2 = sum(results_table.TP_assemblies_CPD(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));

            correct_nmf_nb_neurons_2 = sum(results_table.TP_assemblies_NMF(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));
...
for i = 2:5
    ...
    for cur_nb_intervals_together = 10:10:max_intervals_together
        ...
        for cur_nb_bins_together = 1:5:max_bins_together
            ...
            correct_ica_nb_neurons_2 = sum(results_table.FP_assemblies_ICA(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));

            correct_cpd_nb_neurons_2 = sum(results_table.FP_assemblies_CPD(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));

            correct_nmf_nb_neurons_2 = sum(results_table.FP_assemblies_NMF(results_table.NB_Bins == cur_nb_bins_together & results_table.NB_Neurons == i & results_table.NB_Intervals == cur_nb_intervals_together));
