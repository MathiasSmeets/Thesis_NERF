                    ...
                    for kk = 1:size(stimulus_data_m,2)
                        if ~isempty(stimulus_data_m{i,kk})
                            if peaks_to_keep_m(jj) + max_peak_distance > interval_size % edge case
                                [cur_peak_m, cur_loc_peak_m] = findpeaks(stimulus_data_m{i,kk}(j,peaks_to_keep_m(jj) - max_peak_distance:end),'NPeaks',1);
                            ...
                            elseif peaks_to_keep_m(jj) - max_peak_distance < 1 % edge case
                                [cur_peak_m, cur_loc_peak_m] = findpeaks(stimulus_data_m{i,kk}(j,1:peaks_to_keep_m(jj) + max_peak_distance),'NPeaks',1);
                                ...
                                [cur_peak_m, cur_loc_peak_m] = findpeaks(stimulus_data_m{i,kk}(j,peaks_to_keep_m(jj) - max_peak_distance:peaks_to_keep_m(jj) + max_peak_distance),'NPeaks',1);
