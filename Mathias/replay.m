...
%error("stop")
save('/scratch/mathiass-takeokalab/01/template_y.mat', 'template')
save('/scratch/mathiass-takeokalab/01/template_cluster_y.mat', 'template_cluster')
save('/scratch/mathiass-takeokalab/01/template_smoothed_3_y.mat', 'template_smoothed')
...
save("/scratch/mathiass-takeokalab/01/raw_before_y.mat","cur_correlation_before")
save("/scratch/mathiass-takeokalab/01/raw_between_y.mat","cur_correlation_between")
save("/scratch/mathiass-takeokalab/01/raw_after_y.mat","cur_correlation_after")
save("/scratch/mathiass-takeokalab/01/raw_horridge_y.mat","cur_correlation_horridge")
...
save("/scratch/mathiass-takeokalab/01/threshold_y.mat","threshold")
...
save("/scratch/mathiass-takeokalab/01/thresholded_before_y.mat","thresholded_before")
save("/scratch/mathiass-takeokalab/01/thresholded_between_y.mat","thresholded_between")
save("/scratch/mathiass-takeokalab/01/thresholded_after_y.mat","thresholded_after")
...
saveas(gcf,"/scratch/mathiass-takeokalab/01/boxplot_bba_y.png")
...
saveas(gcf,"/scratch/mathiass-takeokalab/01/boxplot_ba_y.png")
...
save("/scratch/mathiass-takeokalab/01/correlation_after_smoothed_width3_y.mat","avg_cor_after")
