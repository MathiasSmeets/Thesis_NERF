...
save("/scratch/mathiass-takeokalab/01/thresholded_before_m.mat","thresholded_before")
save("/scratch/mathiass-takeokalab/01/thresholded_between_m.mat","thresholded_between")
save("/scratch/mathiass-takeokalab/01/thresholded_after_m.mat","thresholded_after")
...
saveas(gcf,"/scratch/mathiass-takeokalab/01/boxplot_bba_m.png")
...
save("/scratch/mathiass-takeokalab/01/correlation_after_smoothed_width3_m.mat","avg_cor_after")
