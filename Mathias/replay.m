...
stimulus_data_m = stimulus_data_m.after_stimulus_data_np2;
...
horridge_data_m = horridge_data_m.after_stimulus_switch_np2;
            ...
            if isequal(ica_neurons_of_interest{i,j}(ica_assemblies{i,j}{k}), actual_most_common_cluster)
                if length(ica_activity{i,j}(:,k)) >= 3
                    ...
                    for jj = 1:length(locs)
                        ...
                        cur_assembly_data = cur_raw_data(template_cluster{i}, position_in_data:min(position_in_data+bins_together-1, interval_size_before));
...
save("/scratch/mathiass-takeokalab/01/raw_before_np2.mat","cur_correlation_before")
save("/scratch/mathiass-takeokalab/01/raw_between_np2.mat","cur_correlation_between")
save("/scratch/mathiass-takeokalab/01/raw_after_np2.mat","cur_correlation_after")
save("/scratch/mathiass-takeokalab/01/raw_horridge_np2.mat","cur_correlation_horridge")
...
save("/scratch/mathiass-takeokalab/01/threshold_np2.mat","threshold")
...
save("/scratch/mathiass-takeokalab/01/thresholded_before_np2.mat","thresholded_before")
save("/scratch/mathiass-takeokalab/01/thresholded_between_np2.mat","thresholded_between")
save("/scratch/mathiass-takeokalab/01/thresholded_after_np2.mat","thresholded_after")
...
saveas(gcf,"/scratch/mathiass-takeokalab/01/boxplot_bba_np2.png")
...
saveas(gcf,"/scratch/mathiass-takeokalab/01/boxplot_ba_np2.png")
...
save("/scratch/mathiass-takeokalab/01/correlation_before_smoothed_width3_np2.mat","avg_cor_before")
save("/scratch/mathiass-takeokalab/01/correlation_between_smoothed_width3_np2.mat","avg_cor_between")
save("/scratch/mathiass-takeokalab/01/correlation_after_smoothed_width3_np2.mat","avg_cor_after")
