...
raw_before = load(fullfile(volume_base2, path_to_correlations, "raw_before_m_switchbased.mat")); raw_before = raw_before.cur_correlation_before;
raw_between = load(fullfile(volume_base2, path_to_correlations, "raw_between_m_switchbased.mat")); raw_between = raw_between.cur_correlation_between;
raw_after = load(fullfile(volume_base2, path_to_correlations, "raw_after_m_switchbased.mat")); raw_after = raw_after.cur_correlation_after;
raw_horridge = load(fullfile(volume_base2, path_to_correlations, "raw_horridge_m_switchbased.mat")); raw_horridge = raw_horridge.cur_correlation_horridge;

correlation_distribution_before = load(fullfile(volume_base2, path_to_correlations, "correlation_distribution_before_switchbased_m.mat")); correlation_distribution_before = correlation_distribution_before.correlation_distribution_before;
correlation_distribution_between = load(fullfile(volume_base2, path_to_correlations, "correlation_distribution_between_switchbased_m.mat")); correlation_distribution_between = correlation_distribution_between.correlation_distribution_between;
correlation_distribution_after = load(fullfile(volume_base2, path_to_correlations, "correlation_distribution_after_switchbased_m.mat")); correlation_distribution_after = correlation_distribution_after.correlation_distribution_after;
correlation_distribution_horridge = load(fullfile(volume_base2, path_to_correlations, "correlation_distribution_horridge_switchbased_m.mat")); correlation_distribution_horridge = correlation_distribution_horridge.correlation_distribution_horridge;
...
save(fullfile(volume_base2, path_to_correlations, "results_m_switchbased.mat"), "normalized_averages")
