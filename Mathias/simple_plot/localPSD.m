% Look at the PSD of a local patch of size "binSize", all the patches that
% you want to look at have to be defined in timeband variable
clear
close all
...
if ~exist('init','var')
    ...
    for i=timeBand % to cover 0 to 2400 seconds
