...
%   [x,state] = struct_triu(z) generates x as an upper triangular matrix by
%   using the vector z to fill the matrix column by column. For a matrix x of
%   order n, the vector z should have length n*(n+1)/2. The structure state
